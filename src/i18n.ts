...
const T: Record<string, Record<Locale, string>> = {
  ...
  // ── Message composer: attach ("plus") menu ───────────────────────────────
  'compose.noAttachPerm':  { pl: 'Nie masz uprawnień do wysyłania plików', en: 'You do not have permission to send files', cs: 'Nemáte oprávnění odesílat soubory', de: 'Du hast keine Berechtigung, Dateien zu senden' },
  'compose.addAttachment': { pl: 'Dodaj załącznik',              en: 'Add attachment',          cs: 'Přidat přílohu',             de: 'Anhang hinzufügen'         },
  'compose.uploadFile':    { pl: 'Prześlij plik',                en: 'Upload file',             cs: 'Nahrát soubor',              de: 'Datei hochladen'           },
  'compose.uploadFileDesc':{ pl: 'Zdjęcia, wideo, dokumenty…',   en: 'Photos, videos, documents…', cs: 'Fotky, videa, dokumenty…', de: 'Fotos, Videos, Dokumente…' },
  'compose.pasteHint':     { pl: 'Wklej plik skrótem Ctrl+V lub przeciągnij na okno czatu', en: 'Paste a file with Ctrl+V or drag it onto the chat window', cs: 'Vložte soubor zkratkou Ctrl+V nebo jej přetáhněte do okna chatu', de: 'Füge eine Datei mit Strg+V ein oder ziehe sie in das Chatfenster' },
  'compose.clipboardEmpty':{ pl: 'Schowek nie zawiera obrazka ani pliku', en: 'The clipboard does not contain an image or file', cs: 'Schránka neobsahuje obrázek ani soubor', de: 'Die Zwischenablage enthält kein Bild oder keine Datei' },
  'compose.clipboardNoAccessTauri': { pl: 'Brak dostępu do schowka — użyj skrótu Ctrl+V aby wkleić', en: 'No clipboard access — use Ctrl+V to paste', cs: 'Žádný přístup ke schránce — použijte Ctrl+V pro vložení', de: 'Kein Zugriff auf die Zwischenablage — verwende Strg+V zum Einfügen' },
  'compose.clipboardNoAccessWeb': { pl: 'Brak dostępu do schowka — zezwól w ustawieniach przeglądarki', en: 'No clipboard access — allow it in your browser settings', cs: 'Žádný přístup ke schránce — povolte jej v nastavení prohlížeče', de: 'Kein Zugriff auf die Zwischenablage — erlaube dies in den Browsereinstellungen' },
  'compose.pasteFromClipboard': { pl: 'Wklej ze schowka',        en: 'Paste from clipboard',    cs: 'Vložit ze schránky',         de: 'Aus Zwischenablage einfügen' },
  'compose.pasteFromClipboardDesc': { pl: 'Obrazek, screenshot lub plik', en: 'An image, screenshot, or file', cs: 'Obrázek, snímek obrazovky nebo soubor', de: 'Bild, Screenshot oder Datei' },
  'compose.usePollDesc':   { pl: 'Głosowanie dla członków serwera', en: 'A vote for server members', cs: 'Hlasování pro členy serveru', de: 'Eine Abstimmung für Servermitglieder' },
  'compose.useApp':        { pl: 'Użyj aplikacji',                en: 'Use an app',              cs: 'Použít aplikaci',            de: 'App verwenden'             },
  'compose.useAppDesc':    { pl: 'Komendy botów zaczynające się od /', en: 'Bot commands starting with /', cs: 'Příkazy botů začínající na /', de: 'Bot-Befehle, die mit / beginnen' },
  'compose.textFormatting':{ pl: 'Formatowanie tekstu',          en: 'Text formatting',         cs: 'Formátování textu',          de: 'Textformatierung'          },

  // ── Poll creation modal ──────────────────────────────────────────────────
  'poll.create':           { pl: 'Utwórz ankietę',               en: 'Create poll',             cs: 'Vytvořit anketu',            de: 'Umfrage erstellen'         },
  'poll.question':         { pl: 'Pytanie',                      en: 'Question',                cs: 'Otázka',                     de: 'Frage'                     },
  'poll.questionPh':       { pl: 'Wpisz pytanie ankiety...',     en: 'Enter the poll question...', cs: 'Zadejte otázku ankety...', de: 'Gib die Umfragefrage ein...' },
  'poll.options':          { pl: 'Opcje',                        en: 'Options',                 cs: 'Možnosti',                   de: 'Optionen'                   },
  'poll.optionPh':         { pl: 'Opcja',                        en: 'Option',                  cs: 'Možnost',                    de: 'Option'                     },
  'poll.addOption':        { pl: 'Dodaj opcję',                  en: 'Add option',              cs: 'Přidat možnost',             de: 'Option hinzufügen'         },
  'poll.multiChoice':      { pl: 'Wielokrotny wybór',            en: 'Multiple choice',         cs: 'Vícenásobný výběr',          de: 'Mehrfachauswahl'           },
  'poll.multiChoiceDesc':  { pl: 'Pozwól głosować na więcej niż jedną opcję', en: 'Allow voting for more than one option', cs: 'Povolit hlasování pro více než jednu možnost', de: 'Abstimmung für mehr als eine Option erlauben' },
  'poll.createError':      { pl: 'Błąd tworzenia ankiety',       en: 'Error creating poll',     cs: 'Chyba při vytváření ankety', de: 'Fehler beim Erstellen der Umfrage' },

  // ── Channel edit modal ───────────────────────────────────────────────────
  'channel.edit':          { pl: 'Edytuj kanał',                 en: 'Edit channel',            cs: 'Upravit kanál',              de: 'Kanal bearbeiten'          },
  'channel.descPh':        { pl: 'Opis kanału...',               en: 'Channel description...',  cs: 'Popis kanálu...',            de: 'Kanalbeschreibung...'      },
  'channel.private':       { pl: 'Prywatny',                     en: 'Private',                 cs: 'Soukromý',                   de: 'Privat'                    },
  'channel.privateDesc':   { pl: 'Dostępny dla wybranych ról',   en: 'Available to selected roles', cs: 'Dostupné pro vybrané role', de: 'Verfügbar für ausgewählte Rollen' },
  'channel.roleAccess':    { pl: 'Dostęp dla ról',               en: 'Role access',             cs: 'Přístup podle rolí',          de: 'Rollenzugriff'             },
  'channel.noRoles':       { pl: 'Brak ról — utwórz role w ustawieniach serwera.', en: 'No roles — create roles in server settings.', cs: 'Žádné role — vytvořte role v nastavení serveru.', de: 'Keine Rollen — erstelle Rollen in den Servereinstellungen.' },
  'channel.slowmode':      { pl: 'Tryb wolny',                   en: 'Slow mode',               cs: 'Pomalý režim',               de: 'Slow-Modus'                },
  'channel.slowmode.off':  { pl: 'Wyłączony',                    en: 'Off',                     cs: 'Vypnuto',                    de: 'Aus'                       },
  'channel.slowmode.5s':   { pl: '5 sekund',                     en: '5 seconds',               cs: '5 sekund',                   de: '5 Sekunden'                },
  'channel.slowmode.10s':  { pl: '10 sekund',                    en: '10 seconds',              cs: '10 sekund',                  de: '10 Sekunden'               },
  'channel.slowmode.30s':  { pl: '30 sekund',                    en: '30 seconds',              cs: '30 sekund',                  de: '30 Sekunden'               },
  'channel.slowmode.1m':   { pl: '1 minuta',                     en: '1 minute',                cs: '1 minuta',                   de: '1 Minute'                  },
  'channel.slowmode.5m':   { pl: '5 minut',                      en: '5 minutes',               cs: '5 minut',                    de: '5 Minuten'                 },
  'channel.slowmode.10m':  { pl: '10 minut',                     en: '10 minutes',              cs: '10 minut',                   de: '10 Minuten'                },
  'channel.slowmode.1h':   { pl: '1 godzina',                    en: '1 hour',                  cs: '1 hodina',                   de: '1 Stunde'                  },
  'channel.slowmode.6h':   { pl: '6 godzin',                     en: '6 hours',                 cs: '6 hodin',                    de: '6 Stunden'                 },
  'channel.slowmodeDesc':  { pl: 'Użytkownicy mogą wysyłać wiadomość co', en: 'Members can send a message every', cs: 'Členové mohou odesílat zprávu každých', de: 'Mitglieder können alle' },
  'channel.hourAbbr':      { pl: 'godz',                         en: 'h',                       cs: 'h',                          de: 'Std'                       },
  'channel.background':    { pl: 'Tło kanału',                   en: 'Channel background',      cs: 'Pozadí kanálu',              de: 'Kanalhintergrund'          },
  'channel.changePhoto':   { pl: 'Zmień zdjęcie',                en: 'Change photo',            cs: 'Změnit fotku',               de: 'Foto ändern'               },
  'channel.uploadPhoto':   { pl: 'Wgraj zdjęcie',                en: 'Upload photo',            cs: 'Nahrát fotku',               de: 'Foto hochladen'            },
  'channel.uploadPhotoError': { pl: 'Błąd wgrywania zdjęcia',    en: 'Error uploading photo',   cs: 'Chyba při nahrávání fotky',  de: 'Fehler beim Hochladen des Fotos' },
  'channel.gradientCss':   { pl: 'Gradient CSS (opcjonalnie)',   en: 'CSS gradient (optional)', cs: 'CSS gradient (volitelné)',   de: 'CSS-Verlauf (optional)'    },
  'channel.gradientHint':  { pl: 'Możesz użyć samego gradientu lub w połączeniu ze zdjęciem', en: 'You can use just the gradient or combine it with a photo', cs: 'Můžete použít pouze gradient nebo jej zkombinovat s fotkou', de: 'Du kannst nur den Verlauf verwenden oder ihn mit einem Foto kombinieren' },
  'channel.removeAllBg':   { pl: 'Usuń wszystkie tła',           en: 'Remove all backgrounds',  cs: 'Odstranit všechna pozadí',   de: 'Alle Hintergründe entfernen' },
  'channel.userLimit':     { pl: 'Limit użytkowników',           en: 'User limit',              cs: 'Limit uživatelů',            de: 'Nutzerlimit'               },
  'channel.noLimit':       { pl: 'Brak limitu – każdy może wejść.', en: 'No limit – anyone can join.', cs: 'Žádný limit – kdokoli se může připojit.', de: 'Kein Limit – jeder kann beitreten.' },
  'channel.adminOverLimit':{ pl: 'Admin może dołączyć ponad limit.', en: 'Admins can join over the limit.', cs: 'Admin se může připojit i nad limit.', de: 'Admins können auch über das Limit hinaus beitreten.' },
  'channel.streamQuality': { pl: 'Prędkość strumieniowania',    en: 'Streaming quality',       cs: 'Kvalita streamování',        de: 'Streaming-Qualität'        },
  'channel.bitrateWarning':{ pl: '⚠ Powyżej 64 kbps może wpłynąć na słabe łącza.', en: '⚠ Above 64 kbps may affect weak connections.', cs: '⚠ Nad 64 kbps může ovlivnit slabá připojení.', de: '⚠ Über 64 kbps kann sich bei schwachen Verbindungen auswirken.' },

  // ── Voice call panel ─────────────────────────────────────────────────────
  'common.you':            { pl: 'Ty',                           en: 'You',                     cs: 'Ty',                         de: 'Du'                        },
  'voice.youAreDj':        { pl: 'Jesteś DJ-em',                 en: 'You are the DJ',          cs: 'Jsi DJ',                      de: 'Du bist der DJ'            },
  'voice.userIsDj':        { pl: 'jest DJ-em',                   en: 'is the DJ',               cs: 'je DJ',                       de: 'ist der DJ'                },
  'voice.volume':          { pl: 'Głośność:',                    en: 'Volume:',                 cs: 'Hlasitost:',                  de: 'Lautstärke:'               },
  'voice.screenShared':    { pl: 'EKRAN UDOSTĘPNIONY',           en: 'SCREEN SHARED',           cs: 'OBRAZOVKA SDÍLENA',           de: 'BILDSCHIRM GETEILT'        },
  'voice.isSharingScreen': { pl: 'udostępnia ekran',             en: 'is sharing their screen', cs: 'sdílí obrazovku',             de: 'teilt seinen Bildschirm'   },
  'voice.noViewers':       { pl: 'oglądających',                 en: 'viewers',                 cs: 'diváků',                      de: 'Zuschauer'                 },
  'voice.unmute':          { pl: 'Włącz dźwięk',                 en: 'Unmute',                  cs: 'Zapnout zvuk',                de: 'Ton einschalten'           },
  'voice.mute':            { pl: 'Wycisz',                       en: 'Mute',                    cs: 'Ztlumit',                     de: 'Stummschalten'             },
  'voice.stopWatching':    { pl: 'Zatrzymaj oglądanie',          en: 'Stop watching',           cs: 'Přestat sledovat',            de: 'Zuschauen beenden'         },
  'voice.fullscreen':      { pl: 'Pełny ekran',                  en: 'Fullscreen',              cs: 'Celá obrazovka',              de: 'Vollbild'                  },
  'voice.isSharing':       { pl: 'udostępnia',                   en: 'is sharing',              cs: 'sdílí',                       de: 'teilt'                     },
  'voice.joinWatching':    { pl: 'Dołącz do oglądania',          en: 'Join watching',           cs: 'Připojit se ke sledování',    de: 'Zuschauen beitreten'       },
  'voice.yourStream':      { pl: 'Twoja transmisja',             en: 'Your stream',             cs: 'Váš přenos',                  de: 'Dein Stream'               },
  'voice.microphone':      { pl: 'Mikrofon',                     en: 'Microphone',              cs: 'Mikrofon',                    de: 'Mikrofon'                  },
  'voice.speaker':         { pl: 'Głośnik',                      en: 'Speaker',                 cs: 'Reproduktor',                 de: 'Lautsprecher'              },
  'voice.camera':          { pl: 'Kamera',                       en: 'Camera',                  cs: 'Kamera',                      de: 'Kamera'                    },
  'device.default':        { pl: 'Domyślny',                     en: 'Default',                 cs: 'Výchozí',                     de: 'Standard'                  },
  'device.defaultFem':     { pl: 'Domyślna',                     en: 'Default',                 cs: 'Výchozí',                     de: 'Standard'                  },
  'voice.screenShareQuality': { pl: 'Jakość udostępniania ekranu', en: 'Screen share quality',  cs: 'Kvalita sdílení obrazovky',   de: 'Bildschirmfreigabe-Qualität' },
  'voice.screenShareQualityDesc': { pl: 'HD 720p/60fps — mniejsze łącze · FHD 1080p/60fps — wysoka jakość', en: 'HD 720p/60fps — lower bandwidth · FHD 1080p/60fps — high quality', cs: 'HD 720p/60fps — nižší přenos · FHD 1080p/60fps — vysoká kvalita', de: 'HD 720p/60fps — geringere Bandbreite · FHD 1080p/60fps — hohe Qualität' },
  'voice.noiseReduction':  { pl: 'Redukcja szumów i echo',       en: 'Noise & echo reduction',  cs: 'Redukce šumu a ozvěny',       de: 'Rausch- & Echounterdrückung' },
  'voice.noiseReductionDesc': { pl: 'Wycisza hałas tła i echa mikrofonu w czasie rzeczywistym', en: 'Suppresses background noise and mic echo in real time', cs: 'Potlačuje šum na pozadí a ozvěnu mikrofonu v reálném čase', de: 'Unterdrückt Hintergrundgeräusche und Mikrofonecho in Echtzeit' },
  'voice.noiseDesktopInfo':{ pl: 'Na aplikacji desktopowej redukcja szumów działa na poziomie systemu/przeglądarki (echo, AGC, tłumienie szumów) — dodatkowa bramka szumów jest wyłączona, by zagwarantować stabilne przesyłanie dźwięku.', en: 'On the desktop app, noise reduction runs at the system/browser level (echo, AGC, noise suppression) — the extra noise gate is disabled to guarantee stable audio transmission.', cs: 'V desktopové aplikaci probíhá redukce šumu na úrovni systému/prohlížeče (ozvěna, AGC, potlačení šumu) — dodatečná brána šumu je vypnuta, aby byl zaručen stabilní přenos zvuku.', de: 'In der Desktop-App läuft die Rauschunterdrückung auf System-/Browser-Ebene (Echo, AGC, Rauschunterdrückung) — das zusätzliche Noise Gate ist deaktiviert, um eine stabile Audioübertragung zu gewährleisten.' },
  'voice.noiseGateThreshold': { pl: 'Próg bramki szumów',       en: 'Noise gate threshold',    cs: 'Práh brány šumu',             de: 'Noise-Gate-Schwelle'       },
  'voice.noiseGateLoose':  { pl: 'luźny — prawie wszystko przechodzi', en: 'loose — almost everything passes through', cs: 'volný — projde skoro vše', de: 'locker — fast alles kommt durch' },
  'voice.noiseGateAggressive': { pl: 'agresywny — tylko głośny głos', en: 'aggressive — only loud voice', cs: 'agresivní — jen hlasitý hlas', de: 'aggressiv — nur laute Stimme' },
  'voice.noiseGateBalanced': { pl: 'zrównoważony',               en: 'balanced',                cs: 'vyvážený',                    de: 'ausgewogen'                },
  ...
  'search.noResults':      { pl: 'Brak wyników',                 en: 'No results',              cs: 'Žádné výsledky',              de: 'Keine Ergebnisse'          },

  // ── Server Discovery (full-screen browse page) ───────────────────────────
  'discovery.exploreServers': { pl: 'Odkryj serwery',            en: 'Explore servers',         cs: 'Objevit servery',             de: 'Server entdecken'          },
  'discovery.cat.home':    { pl: 'Strona główna',                en: 'Home',                    cs: 'Domů',                        de: 'Startseite'                },
  'discovery.cat.trending': { pl: 'Na czasie',                   en: 'Trending',                cs: 'Populární',                   de: 'Angesagt'                  },
  'discovery.searchPh':    { pl: 'Szukaj publicznych serwerów…', en: 'Search public servers…',  cs: 'Hledat veřejné servery…',     de: 'Öffentliche Server durchsuchen…' },
  'discovery.categories':  { pl: 'Kategorie',                    en: 'Categories',              cs: 'Kategorie',                   de: 'Kategorien'                },
  'discovery.heroTitle':   { pl: 'Znajdź swoją społeczność',     en: 'Find your community',     cs: 'Najděte svou komunitu',       de: 'Finde deine Community'     },
  'discovery.heroDesc':    { pl: 'Przeglądaj tysiące publicznych serwerów — gry, muzyka, nauka i nie tylko.', en: 'Browse thousands of public servers — gaming, music, education and more.', cs: 'Procházejte tisíce veřejných serverů — hry, hudba, vzdělávání a další.', de: 'Durchstöbere Tausende öffentlicher Server — Gaming, Musik, Bildung und mehr.' },
  'discovery.resultsFor':  { pl: 'Wyniki dla',                   en: 'Results for',             cs: 'Výsledky pro',                de: 'Ergebnisse für'            },
  'discovery.server.one':  { pl: 'serwer',                       en: 'server',                  cs: 'server',                      de: 'Server'                    },
  'discovery.server.few':  { pl: 'serwery',                      en: 'servers',                 cs: 'servery',                     de: 'Server'                    },
  'discovery.server.many': { pl: 'serwerów',                     en: 'servers',                 cs: 'serverů',                     de: 'Server'                    },
  'discovery.loading':     { pl: 'Ładowanie serwerów…',          en: 'Loading servers…',        cs: 'Načítání serverů…',           de: 'Server werden geladen…'    },
  'discovery.noServersInCategory': { pl: 'Brak serwerów w tej kategorii', en: 'No servers in this category', cs: 'Žádné servery v této kategorii', de: 'Keine Server in dieser Kategorie' },
  'discovery.clearSearch': { pl: 'Wyczyść wyszukiwanie',         en: 'Clear search',            cs: 'Vymazat hledání',             de: 'Suche löschen'             },
  'discovery.official':    { pl: 'Oficjalny',                    en: 'Official',                cs: 'Oficiální',                   de: 'Offiziell'                 },
  'discovery.noDescription': { pl: 'Brak opisu',                 en: 'No description',          cs: 'Bez popisu',                  de: 'Keine Beschreibung'        },
  'discovery.members':     { pl: 'członków',                     en: 'members',                 cs: 'členů',                       de: 'Mitglieder'                },
  'discovery.alreadyJoined': { pl: 'Jesteś na serwerze →',       en: 'You are in this server →', cs: 'Jste na serveru →',          de: 'Du bist auf diesem Server →' },
  'discovery.join':        { pl: 'Dołącz',                       en: 'Join',                    cs: 'Připojit se',                 de: 'Beitreten'                 },
  'discovery.joinedToast': { pl: 'Dołączono do',                 en: 'Joined',                  cs: 'Připojeno k',                 de: 'Beigetreten zu'            },

  // ── Server onboarding welcome modal ───────────────────────────────────────
