...
const T: Record<string, Record<Locale, string>> = {
  ...
  'settings.notifications':  { pl: 'Powiadomienia',            en: 'Notifications',           cs: 'Oznámení',                  de: 'Benachrichtigungen'        },
  'settings.section.quietHours': { pl: 'Godziny ciszy',        en: 'Quiet hours',             cs: 'Klidové hodiny',            de: 'Ruhezeiten'                },
  'settings.stats':          { pl: 'Statystyki',               en: 'Statistics',              cs: 'Statistiky',                de: 'Statistiken'               },
  'stats.subtitle':          { pl: 'Twoja aktywność na platformie Cordyn.', en: 'Your activity on the Cordyn platform.', cs: 'Vaše aktivita na platformě Cordyn.', de: 'Deine Aktivität auf der Cordyn-Plattform.' },
  'stats.section.messages':  { pl: 'Wiadomości',               en: 'Messages',                cs: 'Zprávy',                     de: 'Nachrichten'               },
  'stats.messages.total':    { pl: 'Łącznie wysłanych',        en: 'Total sent',              cs: 'Celkem odesláno',            de: 'Insgesamt gesendet'        },
  'stats.messages.thisMonth':{ pl: 'W tym miesiącu',           en: 'This month',              cs: 'Tento měsíc',                de: 'Diesen Monat'              },
  'stats.messages.ofTotal':  { pl: '% całości',                en: '% of total',              cs: '% z celku',                  de: '% der Gesamtzahl'          },
  'stats.messages.dm':       { pl: 'Wiadomości DM',            en: 'DM messages',             cs: 'Zprávy DM',                  de: 'DM-Nachrichten'            },
  'stats.section.reactions': { pl: 'Reakcje',                  en: 'Reactions',               cs: 'Reakce',                     de: 'Reaktionen'                },
  'stats.reactions.given':   { pl: 'Dodane przez Ciebie',      en: 'Added by you',            cs: 'Přidané vámi',               de: 'Von dir hinzugefügt'       },
  'stats.reactions.received':{ pl: 'Otrzymane',                en: 'Received',                cs: 'Obdržené',                   de: 'Erhalten'                  },
  'stats.section.account':   { pl: 'Twoje konto',              en: 'Your account',            cs: 'Váš účet',                   de: 'Dein Konto'                },
  'stats.servers':           { pl: 'Serwery',                  en: 'Servers',                 cs: 'Servery',                    de: 'Server'                    },
  'stats.friends':           { pl: 'Znajomi',                  en: 'Friends',                 cs: 'Přátelé',                    de: 'Freunde'                   },
  'stats.memberSince':       { pl: 'Na Cordyn od',             en: 'On Cordyn since',         cs: 'Na Cordyn od',               de: 'Auf Cordyn seit'           },
  'stats.days':              { pl: 'dni',                      en: 'days',                    cs: 'dní',                        de: 'Tagen'                     },
  'admin.lastActive':        { pl: 'Ostatnia aktywność',       en: 'Last active',             cs: 'Poslední aktivita',          de: 'Zuletzt aktiv'             },
  'admin.since':             { pl: 'od',                       en: 'since',                   cs: 'od',                         de: 'seit'                      },
  'accounts.one':            { pl: 'konto',                    en: 'account',                 cs: 'účet',                       de: 'Konto'                     },
  'accounts.few':            { pl: 'konta',                    en: 'accounts',                cs: 'účty',                       de: 'Konten'                    },
  'accounts.many':           { pl: 'kont',                     en: 'accounts',                cs: 'účtů',                       de: 'Konten'                    },

  // ── Connected accounts (Spotify/Twitch/Steam/YouTube/Kick/Epic) ────────────
  'connections.notConnected':  { pl: 'Nie połączono',            en: 'Not connected',           cs: 'Nepřipojeno',               de: 'Nicht verbunden'           },
  'connections.connectedAs':   { pl: 'Połączono jako',           en: 'Connected as',            cs: 'Připojeno jako',            de: 'Verbunden als'             },
  'connections.disconnect':    { pl: 'Odłącz',                   en: 'Disconnect',              cs: 'Odpojit',                   de: 'Trennen'                   },
  'connections.connect':       { pl: 'Połącz',                    en: 'Connect',                 cs: 'Připojit',                  de: 'Verbinden'                 },
  'connections.showOnProfile': { pl: 'Wyświetlaj w profilu',      en: 'Show on profile',         cs: 'Zobrazit v profilu',        de: 'Im Profil anzeigen'        },
  'connections.disconnectedToast': { pl: 'odłączono',            en: 'disconnected',            cs: 'odpojeno',                  de: 'getrennt'                  },
  'connections.connectedToast':    { pl: 'połączono',            en: 'connected',               cs: 'připojeno',                 de: 'verbunden'                 },
  'connections.disconnectError':   { pl: 'Błąd odłączania',      en: 'Error disconnecting',     cs: 'Chyba při odpojování',      de: 'Fehler beim Trennen'       },
  'connections.error':             { pl: 'Błąd',                 en: 'Error',                   cs: 'Chyba',                     de: 'Fehler'                    },
  'connections.live':               { pl: 'NA ŻYWO',             en: 'LIVE',                    cs: 'ŽIVĚ',                      de: 'LIVE'                      },
  'connections.spotify.desc':  { pl: 'Inni widzą co teraz grasz', en: "Others see what's currently playing", cs: 'Ostatní vidí, co právě posloucháte', de: 'Andere sehen, was du gerade hörst' },
  'connections.twitch.desc':   { pl: 'Inni widzą kiedy streamujesz', en: 'Others see when you stream', cs: 'Ostatní vidí, kdy streamujete', de: 'Andere sehen, wenn du streamst' },
  'connections.steam.desc':    { pl: 'Inni widzą co grasz na Steam', en: "Others see what you're playing on Steam", cs: 'Ostatní vidí, co hrajete na Steamu', de: 'Andere sehen, was du auf Steam spielst' },
  'connections.youtube.desc':  { pl: 'Inni widzą Twój kanał YouTube', en: 'Others see your YouTube channel', cs: 'Ostatní vidí váš kanál YouTube', de: 'Andere sehen deinen YouTube-Kanal' },
  'connections.kick.desc':     { pl: 'Inni widzą kiedy streamujesz na Kick', en: 'Others see when you stream on Kick', cs: 'Ostatní vidí, kdy streamujete na Kicku', de: 'Andere sehen, wenn du auf Kick streamst' },
  'connections.epic.desc':     { pl: 'Inni widzą Twoje konto Epic / statystyki Fortnite', en: 'Others see your Epic account / Fortnite stats', cs: 'Ostatní vidí váš účet Epic / statistiky Fortnite', de: 'Andere sehen dein Epic-Konto / Fortnite-Statistiken' },
  'connections.epic.wins':     { pl: 'wygranych',                en: 'wins',                    cs: 'výher',                     de: 'Siege'                     },

  // ── Server soundboard panel ─────────────────────────────────────────────
  'sounds.panelTitle':     { pl: 'Panel dźwięków',           en: 'Soundboard',              cs: 'Zvukový panel',              de: 'Sound-Panel'               },
  'sounds.upload':         { pl: 'Prześlij dźwięk',          en: 'Upload sound',            cs: 'Nahrát zvuk',                de: 'Sound hochladen'           },
  'sounds.limitDesc':      { pl: 'Niestandardowe dźwięki dostępne dla wszystkich podczas rozmów głosowych. Limit:', en: 'Custom sounds available to everyone during voice calls. Limit:', cs: 'Vlastní zvuky dostupné všem během hovorů. Limit:', de: 'Eigene Sounds für alle während Sprachanrufen verfügbar. Limit:' },
  'sounds.loading':        { pl: 'Ładowanie...',             en: 'Loading...',              cs: 'Načítání...',                de: 'Wird geladen...'           },
  'sounds.none':           { pl: 'Brak własnych dźwięków',   en: 'No custom sounds yet',    cs: 'Zatím žádné vlastní zvuky',  de: 'Noch keine eigenen Sounds' },
  'sounds.addFirst':       { pl: 'Dodaj pierwszy dźwięk za pomocą przycisku powyżej', en: 'Add your first sound using the button above', cs: 'Přidejte první zvuk pomocí tlačítka výše', de: 'Füge deinen ersten Sound über den Button oben hinzu' },
  'sounds.col.emojiName':  { pl: 'Emoji / Nazwa',            en: 'Emoji / Name',            cs: 'Emoji / Název',              de: 'Emoji / Name'              },
  'sounds.col.volume':     { pl: 'Głośność',                 en: 'Volume',                  cs: 'Hlasitost',                  de: 'Lautstärke'                },
  'sounds.col.addedBy':    { pl: 'Dodane przez',             en: 'Added by',                cs: 'Přidal',                     de: 'Hinzugefügt von'           },
  'sounds.clickToPick':    { pl: 'Kliknij aby wybrać plik audio', en: 'Click to choose an audio file', cs: 'Klikněte pro výběr audio souboru', de: 'Klicken, um eine Audiodatei auszuwählen' },
  'sounds.selectClip':     { pl: 'Zaznacz fragment',         en: 'Select clip',             cs: 'Vyberte úsek',               de: 'Ausschnitt wählen'         },
  'sounds.tooLong':        { pl: '— za długi!',              en: '— too long!',             cs: '— příliš dlouhé!',           de: '— zu lang!'                },
  'sounds.nameLabel':      { pl: 'Nazwa dźwięku *',          en: 'Sound name *',            cs: 'Název zvuku *',              de: 'Sound-Name *'              },
  'sounds.clipTooLong':    { pl: 'Zaznaczony fragment jest za długi', en: 'Selected clip is too long', cs: 'Vybraný úsek je příliš dlouhý', de: 'Der ausgewählte Ausschnitt ist zu lang' },
  'sounds.adjustHandles':  { pl: 'Przesuń uchwyty na fali dźwiękowej, aby zaznaczyć maks.', en: 'Drag the handles on the waveform to select at most', cs: 'Přetáhněte úchyty na vlnovém tvaru pro výběr max.', de: 'Ziehe die Griffe auf der Wellenform, um maximal auszuwählen' },
  'sounds.uploading':      { pl: 'Przesyłanie...',           en: 'Uploading...',            cs: 'Nahrávání...',               de: 'Wird hochgeladen...'       },
  'sounds.orType':         { pl: 'lub wpisz...',             en: 'or type...',              cs: 'nebo napište...',            de: 'oder eingeben...'          },

  // ── Server settings: General / Roles / Members ──────────────────────────
  'srv.general':           { pl: 'Ogólne',                   en: 'General',                 cs: 'Obecné',                     de: 'Allgemein'                 },
  'srv.banner':            { pl: 'Banner',                   en: 'Banner',                  cs: 'Banner',                     de: 'Banner'                    },
  'srv.changeBanner':      { pl: 'Zmień banner',             en: 'Change banner',           cs: 'Změnit banner',              de: 'Banner ändern'             },
  'srv.icon':              { pl: 'Ikona',                    en: 'Icon',                    cs: 'Ikona',                      de: 'Symbol'                    },
  'srv.changeIcon':        { pl: 'Zmień ikonę',              en: 'Change icon',             cs: 'Změnit ikonu',               de: 'Symbol ändern'             },
  'srv.name':              { pl: 'Nazwa',                    en: 'Name',                    cs: 'Název',                      de: 'Name'                      },
  'srv.description':       { pl: 'Opis',                     en: 'Description',             cs: 'Popis',                      de: 'Beschreibung'              },
  'srv.descriptionPh':      { pl: 'Opis serwera...',          en: 'Server description...',   cs: 'Popis serveru...',           de: 'Serverbeschreibung...'     },
  'srv.accentColor':       { pl: 'Kolor akcentu serwera',    en: 'Server accent color',     cs: 'Barva akcentu serveru',      de: 'Server-Akzentfarbe'        },
  'srv.roles':             { pl: 'Role',                     en: 'Roles',                   cs: 'Role',                       de: 'Rollen'                    },
  'srv.newRole':           { pl: 'Nowa rola',                en: 'New role',                cs: 'Nová role',                  de: 'Neue Rolle'                },
  'srv.noRoles':           { pl: 'Brak ról',                 en: 'No roles',                cs: 'Žádné role',                 de: 'Keine Rollen'              },
  'srv.default':           { pl: 'Domyślny',                 en: 'Default',                 cs: 'Výchozí',                    de: 'Standard'                  },
  'srv.permissionsCount':  { pl: 'uprawnień',                en: 'permissions',             cs: 'oprávnění',                  de: 'Berechtigungen'            },
  'srv.members':           { pl: 'Członkowie',               en: 'Members',                 cs: 'Členové',                    de: 'Mitglieder'                },
  'srv.searchMember':      { pl: 'Szukaj członka...',        en: 'Search member...',        cs: 'Hledat člena...',            de: 'Mitglied suchen...'        },
  'srv.col.user':          { pl: 'Użytkownik',               en: 'User',                    cs: 'Uživatel',                   de: 'Benutzer'                  },
  'srv.col.role':          { pl: 'Rola',                     en: 'Role',                    cs: 'Role',                       de: 'Rolle'                     },
  'srv.col.joined':        { pl: 'Dołączył',                 en: 'Joined',                  cs: 'Připojil se',                de: 'Beigetreten'               },
  'srv.col.actions':       { pl: 'Akcje',                    en: 'Actions',                 cs: 'Akce',                       de: 'Aktionen'                  },

  // ── Server settings: Bans / Invites ─────────────────────────────────────
  'srv.banned':            { pl: 'Zbanowani',                en: 'Banned',                  cs: 'Zabanovaní',                 de: 'Gebannt'                   },
  'srv.noBanned':          { pl: 'Brak zbanowanych użytkowników.', en: 'No banned users.',  cs: 'Žádní zabanovaní uživatelé.', de: 'Keine gebannten Benutzer.' },
  'srv.reason':            { pl: 'Powód',                    en: 'Reason',                  cs: 'Důvod',                      de: 'Grund'                     },
  'srv.by':                { pl: 'przez',                    en: 'by',                      cs: 'od',                          de: 'von'                       },
  'invites.title':         { pl: 'Zaproszenia',              en: 'Invites',                 cs: 'Pozvánky',                   de: 'Einladungen'               },
  'invites.desc':          { pl: 'Linki, kody i metody dołączania do', en: 'Links, codes and ways to join', cs: 'Odkazy, kódy a způsoby připojení k', de: 'Links, Codes und Wege, um beizutreten zu' },
  'invites.permanentLink': { pl: 'Stały link zaproszenia',   en: 'Permanent invite link',   cs: 'Trvalý pozvánkový odkaz',    de: 'Dauerhafter Einladungslink' },
  'invites.copyLink':      { pl: 'Kopiuj link',              en: 'Copy link',               cs: 'Kopírovat odkaz',            de: 'Link kopieren'             },
  'invites.share':         { pl: 'Udostępnij',               en: 'Share',                   cs: 'Sdílet',                     de: 'Teilen'                    },
  'invites.code':          { pl: 'Kod zaproszenia:',         en: 'Invite code:',            cs: 'Kód pozvánky:',              de: 'Einladungscode:'           },
  'invites.copyCode':      { pl: 'Kopiuj kod',               en: 'Copy code',               cs: 'Kopírovat kód',              de: 'Code kopieren'             },
  'invites.codeCopied':    { pl: 'Kod skopiowany!',          en: 'Code copied!',            cs: 'Kód zkopírován!',            de: 'Code kopiert!'             },
  'invites.expires':       { pl: 'Wygasa:',                  en: 'Expires:',                cs: 'Vyprší:',                    de: 'Läuft ab:'                 },
  'invites.never':         { pl: 'nigdy',                    en: 'never',                   cs: 'nikdy',                      de: 'nie'                       },
  'invites.limit':         { pl: 'Limit:',                   en: 'Limit:',                  cs: 'Limit:',                     de: 'Limit:'                    },
  'invites.none':          { pl: 'brak',                     en: 'none',                    cs: 'žádný',                      de: 'keins'                     },
  'invites.usedTimes':     { pl: 'Użyto:',                   en: 'Used:',                   cs: 'Použito:',                   de: 'Verwendet:'                },
  'invites.times':         { pl: 'razy',                     en: 'times',                   cs: 'krát',                       de: 'Mal'                       },
  'invites.noPermanent':   { pl: 'Brak stałego linku. Utwórz stały link bez daty wygaśnięcia.', en: 'No permanent link. Create a permanent link with no expiry date.', cs: 'Žádný trvalý odkaz. Vytvořte trvalý odkaz bez data vypršení.', de: 'Kein dauerhafter Link. Erstelle einen dauerhaften Link ohne Ablaufdatum.' },
  'invites.createPermanent': { pl: 'Utwórz stały link',      en: 'Create permanent link',   cs: 'Vytvořit trvalý odkaz',      de: 'Dauerhaften Link erstellen' },
  'invites.permanentCreated': { pl: 'Stały link utworzony!', en: 'Permanent link created!', cs: 'Trvalý odkaz vytvořen!',     de: 'Dauerhafter Link erstellt!' },
  'invites.newTemp':       { pl: 'Nowy link tymczasowy',     en: 'New temporary link',      cs: 'Nový dočasný odkaz',         de: 'Neuer temporärer Link'     },
  'invites.validity':      { pl: 'Ważność',                  en: 'Validity',                cs: 'Platnost',                   de: 'Gültigkeit'                },
  'invites.usesLimit':     { pl: 'Limit użyć',               en: 'Use limit',               cs: 'Limit použití',              de: 'Nutzungslimit'             },
  'invites.unlimited':     { pl: 'Bez limitu',               en: 'Unlimited',               cs: 'Bez limitu',                 de: 'Unbegrenzt'                },
  'invites.oneUse':        { pl: 'użycie',                   en: 'use',                     cs: 'použití',                    de: 'Nutzung'                   },
  'invites.uses':          { pl: 'użyć',                     en: 'uses',                    cs: 'použití',                    de: 'Nutzungen'                 },
  'invites.generateNew':   { pl: 'Generuj nowy link',        en: 'Generate new link',       cs: 'Vygenerovat nový odkaz',     de: 'Neuen Link generieren'     },
  'invites.activeLinks':   { pl: 'Aktywne linki',            en: 'Active links',            cs: 'Aktivní odkazy',             de: 'Aktive Links'              },
  'invites.noActive':      { pl: 'Brak aktywnych linków zaproszeniowych.', en: 'No active invite links.', cs: 'Žádné aktivní pozvánkové odkazy.', de: 'Keine aktiven Einladungslinks.' },
  'invites.createAbove':   { pl: 'Utwórz nowy link powyżej.', en: 'Create a new link above.', cs: 'Vytvořte nový odkaz výše.', de: 'Erstelle oben einen neuen Link.' },
  'invites.permanent':     { pl: 'Stały',                    en: 'Permanent',               cs: 'Trvalý',                     de: 'Dauerhaft'                 },
  'invites.link':          { pl: 'Link',                     en: 'Link',                    cs: 'Odkaz',                      de: 'Link'                      },
  'invites.copyCodeOnly':  { pl: 'Kopiuj sam kod',           en: 'Copy code only',          cs: 'Kopírovat pouze kód',        de: 'Nur Code kopieren'         },
  'common.error':          { pl: 'Błąd',                     en: 'Error',                   cs: 'Chyba',                      de: 'Fehler'                    },
  'invites.dur.30m':       { pl: '30 minut',                 en: '30 minutes',              cs: '30 minut',                   de: '30 Minuten'                },
  'invites.dur.1h':        { pl: '1 godzina',                en: '1 hour',                  cs: '1 hodina',                   de: '1 Stunde'                  },
  'invites.dur.6h':        { pl: '6 godzin',                 en: '6 hours',                 cs: '6 hodin',                    de: '6 Stunden'                 },
  'invites.dur.1d':        { pl: '1 dzień',                  en: '1 day',                   cs: '1 den',                      de: '1 Tag'                     },
  'invites.dur.3d':        { pl: '3 dni',                    en: '3 days',                  cs: '3 dny',                      de: '3 Tage'                    },
  'invites.dur.7d':        { pl: '7 dni',                    en: '7 days',                  cs: '7 dní',                      de: '7 Tage'                    },
  'invites.dur.never':     { pl: 'Nigdy',                    en: 'Never',                   cs: 'Nikdy',                      de: 'Nie'                       },
  'invites.deleted':       { pl: 'Zaproszenie usunięte',     en: 'Invite deleted',          cs: 'Pozvánka smazána',           de: 'Einladung gelöscht'        },

  // ── Server settings: Events ─────────────────────────────────────────────
  'srv.events.title':      { pl: 'Eventy serwera',           en: 'Server events',           cs: 'Události serveru',           de: 'Server-Events'             },
  'srv.events.desc':       { pl: 'Twórz i zarządzaj zaplanowanymi wydarzeniami dla członków serwera.', en: 'Create and manage scheduled events for server members.', cs: 'Vytvářejte a spravujte naplánované události pro členy serveru.', de: 'Erstelle und verwalte geplante Events für Servermitglieder.' },
  'srv.events.descCompact':{ pl: 'Zarządzaj eventami serwera. Utwórz, edytuj lub usuń zaplanowane wydarzenia.', en: 'Manage server events. Create, edit, or delete scheduled events.', cs: 'Spravujte události serveru. Vytvářejte, upravujte nebo mažte naplánované události.', de: 'Verwalte Server-Events. Erstelle, bearbeite oder lösche geplante Events.' },
  'srv.events.new':        { pl: 'Nowy event',               en: 'New event',               cs: 'Nová událost',               de: 'Neues Event'               },
  'srv.events.titlePh':    { pl: 'Tytuł eventu*',            en: 'Event title*',            cs: 'Název události*',            de: 'Event-Titel*'              },
  'srv.events.descPh':     { pl: 'Opis (opcjonalnie)',       en: 'Description (optional)',  cs: 'Popis (volitelné)',          de: 'Beschreibung (optional)'   },
  'srv.events.titlePhShort':{ pl: 'Tytuł*',                  en: 'Title*',                  cs: 'Název*',                     de: 'Titel*'                    },
  'srv.events.descPhShort':{ pl: 'Opis',                     en: 'Description',             cs: 'Popis',                      de: 'Beschreibung'              },
  'srv.events.dateLabel':  { pl: 'Data i godzina*',          en: 'Date and time*',          cs: 'Datum a čas*',               de: 'Datum und Uhrzeit*'        },
  'srv.events.channelLabel':{ pl: 'Kanał (opcjonalnie)',     en: 'Channel (optional)',      cs: 'Kanál (volitelné)',          de: 'Kanal (optional)'          },
  'srv.events.created':    { pl: 'Event utworzony!',         en: 'Event created!',          cs: 'Událost vytvořena!',         de: 'Event erstellt!'           },
  'srv.events.deleted':    { pl: 'Usunięto event',           en: 'Event deleted',           cs: 'Událost smazána',            de: 'Event gelöscht'            },
  'srv.events.createBtn':  { pl: 'Utwórz event',             en: 'Create event',            cs: 'Vytvořit událost',           de: 'Event erstellen'           },
  'srv.events.emptyMain':  { pl: 'Brak eventów. Utwórz pierwszy!', en: 'No events. Create the first one!', cs: 'Žádné události. Vytvořte první!', de: 'Keine Events. Erstelle das erste!' },
  'srv.events.emptyCompact':{ pl: 'Brak eventów',            en: 'No events',               cs: 'Žádné události',             de: 'Keine Events'              },
  'common.noneDash':       { pl: '– brak –',                 en: '– none –',                cs: '– žádný –',                  de: '– keiner –'                },

  // ── Server settings: Onboarding ──────────────────────────────────────────
  'srv.onboarding.title':  { pl: 'Onboarding nowych członków', en: 'New member onboarding', cs: 'Onboarding nových členů',    de: 'Onboarding neuer Mitglieder' },
  'srv.onboarding.desc':   { pl: 'Skonfiguruj ekran powitalny dla nowych osób dołączających do serwera. Możesz ustawić regulamin i automatyczne role.', en: 'Configure the welcome screen for new people joining the server. You can set rules and automatic roles.', cs: 'Nakonfigurujte uvítací obrazovku pro nové lidi připojující se k serveru. Můžete nastavit pravidla a automatické role.', de: 'Konfiguriere den Willkommensbildschirm für neue Server-Mitglieder. Du kannst Regeln und automatische Rollen festlegen.' },
  'srv.onboarding.descCompact': { pl: 'Skonfiguruj powitanie dla nowych członków serwera. Możesz ustawić regulamin i automatyczne przypisanie roli.', en: 'Configure the welcome for new server members. You can set rules and automatic role assignment.', cs: 'Nakonfigurujte uvítání pro nové členy serveru. Můžete nastavit pravidla a automatické přiřazení role.', de: 'Konfiguriere die Begrüßung für neue Server-Mitglieder. Du kannst Regeln und automatische Rollenzuweisung festlegen.' },
  'srv.onboarding.enable': { pl: 'Włącz onboarding',         en: 'Enable onboarding',       cs: 'Povolit onboarding',          de: 'Onboarding aktivieren'     },
  'srv.onboarding.enableDesc': { pl: 'Nowi członkowie zobaczą ekran powitalny z regulaminem', en: 'New members will see a welcome screen with the rules', cs: 'Noví členové uvidí uvítací obrazovku s pravidly', de: 'Neue Mitglieder sehen einen Willkommensbildschirm mit den Regeln' },
  'srv.onboarding.welcomeLabel': { pl: 'Tekst powitalny',    en: 'Welcome text',            cs: 'Uvítací text',                de: 'Willkommenstext'           },
  'srv.onboarding.welcomePh': { pl: 'Witaj na serwerze! Zapoznaj się z regulaminem...', en: 'Welcome to the server! Please read the rules...', cs: 'Vítej na serveru! Přečti si prosím pravidla...', de: 'Willkommen auf dem Server! Bitte lies dir die Regeln durch...' },
  'srv.onboarding.welcomePhShort': { pl: 'Witaj na serwerze!', en: 'Welcome to the server!', cs: 'Vítej na serveru!',         de: 'Willkommen auf dem Server!' },
  'srv.onboarding.rulesLabel': { pl: 'Regulamin / zasady serwera', en: 'Rules / server guidelines', cs: 'Pravidla / pokyny serveru', de: 'Regeln / Serverrichtlinien' },
  'srv.onboarding.rulesLabelCompact': { pl: 'Regulamin (tekst zasad)', en: 'Rules (rules text)', cs: 'Pravidla (text pravidel)', de: 'Regeln (Regeltext)'        },
  'srv.onboarding.rulesPh':{ pl: '§1. Zachowuj szacunek wobec innych.&#10;§2. Zakaz spamu.&#10;§3. ...', en: '§1. Be respectful to others.&#10;§2. No spam.&#10;§3. ...', cs: '§1. Chovejte se k ostatním s respektem.&#10;§2. Zákaz spamu.&#10;§3. ...', de: '§1. Sei respektvoll zu anderen.&#10;§2. Kein Spam.&#10;§3. ...' },
  'srv.onboarding.rulesPhCompact': { pl: 'Wpisz zasady serwera...', en: 'Enter the server rules...', cs: 'Zadejte pravidla serveru...', de: 'Gib die Serverregeln ein...' },
  'srv.onboarding.autoRoleLabel': { pl: 'Automatyczna rola po akceptacji regulaminu', en: 'Automatic role after accepting the rules', cs: 'Automatická role po přijetí pravidel', de: 'Automatische Rolle nach Akzeptieren der Regeln' },
  'srv.onboarding.saved':  { pl: 'Onboarding zapisany!',      en: 'Onboarding saved!',       cs: 'Onboarding uložen!',          de: 'Onboarding gespeichert!'   },
  'srv.onboarding.saveBtn':{ pl: 'Zapisz onboarding',         en: 'Save onboarding',         cs: 'Uložit onboarding',           de: 'Onboarding speichern'      },

  // ── Server settings: Discovery ───────────────────────────────────────────
  'srv.discovery.title':   { pl: 'Publiczne wyszukiwanie',   en: 'Public discovery',        cs: 'Veřejné vyhledávání',        de: 'Öffentliche Auffindbarkeit' },
  'srv.discovery.desc':    { pl: 'Zdecyduj, czy Twój serwer ma być widoczny w katalogu publicznych serwerów. Domyślnie każdy serwer jest prywatny.', en: 'Decide whether your server should be visible in the public server directory. By default every server is private.', cs: 'Rozhodněte, zda má být váš server viditelný ve veřejném adresáři serverů. Ve výchozím nastavení je každý server soukromý.', de: 'Entscheide, ob dein Server im öffentlichen Serververzeichnis sichtbar sein soll. Standardmäßig ist jeder Server privat.' },
  'srv.discovery.descCompact': { pl: 'Zdecyduj, czy Twój serwer ma być widoczny w publicznej liście serwerów.', en: 'Decide whether your server should be visible in the public server list.', cs: 'Rozhodněte, zda má být váš server viditelný ve veřejném seznamu serverů.', de: 'Entscheide, ob dein Server in der öffentlichen Serverliste sichtbar sein soll.' },
  'srv.discovery.publicLabel': { pl: 'Serwer publiczny',     en: 'Public server',           cs: 'Veřejný server',             de: 'Öffentlicher Server'       },
  'srv.discovery.publicLabelCompact': { pl: 'Publiczny serwer', en: 'Public server',         cs: 'Veřejný server',             de: 'Öffentlicher Server'       },
  'srv.discovery.publicDesc': { pl: 'Pojawi się w wyszukiwarce — każdy może dołączyć', en: 'It will appear in search — anyone can join', cs: 'Objeví se ve vyhledávání — kdokoli se může připojit', de: 'Er erscheint in der Suche — jeder kann beitreten' },
  'srv.discovery.publicDescCompact': { pl: 'Każdy może znaleźć ten serwer przez wyszukiwarkę', en: 'Anyone can find this server through search', cs: 'Kdokoli může tento server najít pomocí vyhledávání', de: 'Jeder kann diesen Server über die Suche finden' },
  'srv.discovery.nowPublic': { pl: 'Serwer jest teraz publiczny!', en: 'The server is now public!', cs: 'Server je nyní veřejný!',   de: 'Der Server ist jetzt öffentlich!' },
  'srv.discovery.nowPrivate': { pl: 'Serwer jest teraz prywatny!', en: 'The server is now private!', cs: 'Server je nyní soukromý!', de: 'Der Server ist jetzt privat!' },
  'srv.discovery.categoryLabel': { pl: 'Kategoria serwera',  en: 'Server category',         cs: 'Kategorie serveru',          de: 'Serverkategorie'           },
  'srv.discovery.cat.none': { pl: 'Brak kategorii',          en: 'No category',             cs: 'Žádná kategorie',            de: 'Keine Kategorie'           },
  'srv.discovery.cat.gaming': { pl: 'Gracze',                en: 'Gaming',                  cs: 'Hráči',                       de: 'Gaming'                    },
  'srv.discovery.cat.music': { pl: 'Muzyka',                 en: 'Music',                   cs: 'Hudba',                       de: 'Musik'                     },
  'srv.discovery.cat.entertainment': { pl: 'Rozrywka',       en: 'Entertainment',           cs: 'Zábava',                     de: 'Unterhaltung'              },
  'srv.discovery.cat.education': { pl: 'Edukacja',           en: 'Education',               cs: 'Vzdělávání',                 de: 'Bildung'                   },
  'srv.discovery.cat.science': { pl: 'Nauka i tech',         en: 'Science & tech',          cs: 'Věda a technika',            de: 'Wissenschaft & Technik'    },
  'srv.discovery.descLabel': { pl: 'Opis w katalogu serwerów', en: 'Description in the server directory', cs: 'Popis v adresáři serverů', de: 'Beschreibung im Serververzeichnis' },
  'srv.discovery.descLabelCompact': { pl: 'Opis w katalogu', en: 'Description in the directory', cs: 'Popis v adresáři',    de: 'Beschreibung im Verzeichnis' },
  'srv.discovery.descPh':  { pl: 'Opisz swój serwer dla przyszłych członków...', en: 'Describe your server for future members...', cs: 'Popište svůj server pro budoucí členy...', de: 'Beschreibe deinen Server für zukünftige Mitglieder...' },
  'srv.discovery.descPhCompact': { pl: 'Opisz swój serwer dla nowych użytkowników...', en: 'Describe your server for new users...', cs: 'Popište svůj server pro nové uživatele...', de: 'Beschreibe deinen Server für neue Benutzer...' },
  'srv.discovery.saved':   { pl: 'Ustawienia odkrywalności zapisane!', en: 'Discovery settings saved!', cs: 'Nastavení objevitelnosti uloženo!', de: 'Auffindbarkeitseinstellungen gespeichert!' },
  'srv.discovery.savedCompact': { pl: 'Opis zapisany!',      en: 'Description saved!',      cs: 'Popis uložen!',               de: 'Beschreibung gespeichert!' },
  'srv.discovery.saveBtn': { pl: 'Zapisz ustawienia',        en: 'Save settings',           cs: 'Uložit nastavení',            de: 'Einstellungen speichern'   },

  // ── Events modal (home dashboard) ────────────────────────────────────────
  'srv.events.fillRequired': { pl: 'Wypełnij tytuł i datę',  en: 'Fill in the title and date', cs: 'Vyplňte název a datum',    de: 'Titel und Datum ausfüllen' },
  'srv.events.createNewLabel': { pl: 'Utwórz nowy event',    en: 'Create a new event',      cs: 'Vytvořit novou událost',      de: 'Neues Event erstellen'     },
  'srv.events.emptyModal': { pl: 'Brak zaplanowanych eventów', en: 'No scheduled events',    cs: 'Žádné naplánované události',  de: 'Keine geplanten Events'    },
  'srv.events.deletedModal': { pl: 'Event usunięty',         en: 'Event deleted',           cs: 'Událost smazána',             de: 'Event gelöscht'            },
  'srv.events.confirmDelete': { pl: 'Usunąć event?',         en: 'Delete this event?',      cs: 'Smazat tuto událost?',        de: 'Dieses Event löschen?'     },
  'srv.events.rsvpError':  { pl: 'Błąd RSVP',                en: 'RSVP error',              cs: 'Chyba RSVP',                  de: 'RSVP-Fehler'               },
  'srv.events.rsvpGoing':  { pl: 'Idę',                      en: 'Going',                   cs: 'Jdu',                          de: 'Bin dabei'                 },
  'srv.events.rsvpInterested': { pl: 'Interesuję',           en: 'Interested',              cs: 'Mám zájem',                    de: 'Interessiert'              },
  'srv.events.going':      { pl: 'jedzie',                   en: 'going',                   cs: 'jde',                          de: 'dabei'                     },
  'srv.events.interestedCount': { pl: 'zainteresowanych',    en: 'interested',              cs: 'se zajímá',                    de: 'interessiert'              },
  'srv.events.timeIn':     { pl: 'za',                       en: 'in',                      cs: 'za',                           de: 'in'                        },
  'srv.events.timePassed': { pl: 'minęło',                   en: 'passed',                  cs: 'uplynulo',                     de: 'vorbei'                    },
  'onboarding.serverReady': { pl: 'Serwer gotowy!',          en: 'Server ready!',           cs: 'Server je připraven!',         de: 'Server bereit!'            },
  'onboarding.allStepsDone': { pl: 'Wszystkie pierwsze kroki ukończone.', en: 'All first steps completed.', cs: 'Všechny první kroky dokončeny.', de: 'Alle ersten Schritte abgeschlossen.' },
  ...
  // ── Landing page — big showcase sections (Discord-style alternating) ──────
  'landing.showcase.chat.title': { pl: 'ROZMOWY PEŁNE ŻYCIA', en: 'CHATS THAT FEEL ALIVE', cs: 'CHATY PLNÉ ŽIVOTA', de: 'CHATS VOLLER LEBEN' },
  'landing.showcase.chat.desc':  { pl: 'Emotki, GIF-y, reakcje i własne naklejki. Pisz, żartuj, wysyłaj memy — Twój czat, Twoje zasady.', en: 'Emoji, GIFs, reactions and custom stickers. Chat, joke around, send memes — your chat, your rules.', cs: 'Emotikony, GIFy, reakce a vlastní samolepky. Pište, vtipkujte, posílejte memy — váš chat, vaše pravidla.', de: 'Emojis, GIFs, Reaktionen und eigene Sticker. Schreib, witzel, schick Memes — dein Chat, deine Regeln.' },
  'landing.showcase.voice.title': { pl: 'GADAJ, JAKBYŚCIE BYLI OBOK', en: "TALK LIKE YOU'RE IN THE SAME ROOM", cs: 'MLUVTE, JAKO BYSTE BYLI VEDLE SEBE', de: 'REDE, ALS WÄRT IHR IM SELBEN RAUM' },
  'landing.showcase.voice.desc':  { pl: 'HD głos i wideo bez zacięć. Wskakuj na kanał głosowy w sekundę — bez dzwonienia, bez czekania.', en: 'HD voice and video, no lag. Hop into a voice channel in a second — no calling, no waiting.', cs: 'HD hlas a video bez sekání. Naskočte do hlasového kanálu za sekundu — bez volání, bez čekání.', de: 'HD-Sprache und Video ohne Ruckler. Spring in Sekunden in einen Sprachkanal — ohne Anrufen, ohne Warten.' },
  'landing.showcase.servers.title': { pl: 'TWÓJ SERWER, TWOJE ZASADY', en: 'YOUR SERVER, YOUR RULES', cs: 'VÁŠ SERVER, VAŠE PRAVIDLA', de: 'DEIN SERVER, DEINE REGELN' },
  'landing.showcase.servers.desc':  { pl: 'Kanały, role, kategorie, boty — zbuduj przestrzeń dokładnie taką, jakiej potrzebuje Twoja ekipa.', en: 'Channels, roles, categories, bots — build the exact space your crew needs.', cs: 'Kanály, role, kategorie, boti — postavte si přesně takový prostor, jaký vaše parta potřebuje.', de: 'Kanäle, Rollen, Kategorien, Bots — bau genau den Raum, den deine Crew braucht.' },
