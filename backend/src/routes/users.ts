...
router.put('/me', authMiddleware,
  [
    ...
    body('banner_preset').optional().isIn(['none','aurora','violet','fire','ocean','neon-pink','matrix','gold','galaxy','ice','sakura','cyber','city','space','forest','mountains','rain','lava','misty-forest','deep-space','night-city']),
  ],
